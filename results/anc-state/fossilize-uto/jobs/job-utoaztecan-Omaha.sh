...
#PBS -o /panfs/panasas01/arch/sp16194/terminology-anc-state/fossilize-uto/logs/utoaztecan-Omaha-fossilize-output.txt
#PBS -e /panfs/panasas01/arch/sp16194/terminology-anc-state/fossilize-uto/logs/utoaztecan-Omaha-fossilize-error.txt
...
Fossil Node01 root 6
LogFile fossilize-uto/output/Omaha_$DATE;
run;
ANSWERS
