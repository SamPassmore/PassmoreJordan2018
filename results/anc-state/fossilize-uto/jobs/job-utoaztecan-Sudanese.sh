...
#PBS -o /panfs/panasas01/arch/sp16194/terminology-anc-state/fossilize-uto/logs/utoaztecan-Sudanese-fossilize-output.txt
#PBS -e /panfs/panasas01/arch/sp16194/terminology-anc-state/fossilize-uto/logs/utoaztecan-Sudanese-fossilize-error.txt
...
Fossil Node01 root 7
LogFile fossilize-uto/output/Sudanese_$DATE;
run;
ANSWERS
