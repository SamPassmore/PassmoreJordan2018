...
#PBS -o /panfs/panasas01/arch/sp16194/terminology-anc-state/fossilize-uto/logs/utoaztecan-Descriptive-fossilize-output.txt
#PBS -e /panfs/panasas01/arch/sp16194/terminology-anc-state/fossilize-uto/logs/utoaztecan-Descriptive-fossilize-error.txt
...
Fossil Node01 root 2
LogFile fossilize-uto/output/Descriptive_$DATE;
run;
ANSWERS
