...
#PBS -o /panfs/panasas01/arch/sp16194/terminology-anc-state/fossilize-uto/logs/utoaztecan-Hawaiian-fossilize-output.txt
#PBS -e /panfs/panasas01/arch/sp16194/terminology-anc-state/fossilize-uto/logs/utoaztecan-Hawaiian-fossilize-error.txt
...
Fossil Node01 root 4
LogFile fossilize-uto/output/Hawaiian_$DATE;
run;
ANSWERS
