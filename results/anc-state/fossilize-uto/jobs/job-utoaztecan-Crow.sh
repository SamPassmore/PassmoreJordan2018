...
#PBS -o /panfs/panasas01/arch/sp16194/terminology-anc-state/fossilize-uto/logs/utoaztecan-Crow-fossilize-output.txt
#PBS -e /panfs/panasas01/arch/sp16194/terminology-anc-state/fossilize-uto/logs/utoaztecan-Crow-fossilize-error.txt
...
Fossil Node01 root 1
LogFile fossilize-uto/output/Crow_$DATE;
run;
ANSWERS
