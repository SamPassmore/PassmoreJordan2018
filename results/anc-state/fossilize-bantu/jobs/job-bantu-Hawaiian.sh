...
#PBS -o /panfs/panasas01/arch/sp16194/terminology-anc-state/fossilize-bantu/logs/bantu-Hawaiian-fossilize-output.txt
#PBS -e /panfs/panasas01/arch/sp16194/terminology-anc-state/fossilize-bantu/logs/bantu-Hawaiian-fossilize-error.txt
...
LogFile fossilize-bantu/output/Hawaiian_$DATE;
run;
ANSWERS
