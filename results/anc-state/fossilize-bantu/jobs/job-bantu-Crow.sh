...
#PBS -o /panfs/panasas01/arch/sp16194/terminology-anc-state/fossilize-bantu/logs/bantu-Crow-fossilize-output.txt
#PBS -e /panfs/panasas01/arch/sp16194/terminology-anc-state/fossilize-bantu/logs/bantu-Crow-fossilize-error.txt
...
LogFile fossilize-bantu/output/Crow_$DATE;
run;
ANSWERS
