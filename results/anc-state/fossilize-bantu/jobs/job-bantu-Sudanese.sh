...
#PBS -o /panfs/panasas01/arch/sp16194/terminology-anc-state/fossilize-bantu/logs/bantu-Sudanese-fossilize-output.txt
#PBS -e /panfs/panasas01/arch/sp16194/terminology-anc-state/fossilize-bantu/logs/bantu-Sudanese-fossilize-error.txt
...
LogFile fossilize-bantu/output/Sudanese_$DATE;
run;
ANSWERS
