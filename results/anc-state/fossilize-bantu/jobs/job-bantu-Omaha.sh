...
#PBS -o /panfs/panasas01/arch/sp16194/terminology-anc-state/fossilize-bantu/logs/bantu-Omaha-fossilize-output.txt
#PBS -e /panfs/panasas01/arch/sp16194/terminology-anc-state/fossilize-bantu/logs/bantu-Omaha-fossilize-error.txt
...
LogFile fossilize-bantu/output/Omaha_$DATE;
run;
ANSWERS
