...
#PBS -o /panfs/panasas01/arch/sp16194/terminology-anc-state/fossilize-bantu/logs/bantu-Descriptive-fossilize-output.txt
#PBS -e /panfs/panasas01/arch/sp16194/terminology-anc-state/fossilize-bantu/logs/bantu-Descriptive-fossilize-error.txt
...
LogFile fossilize-bantu/output/Descriptive_$DATE;
run;
ANSWERS
