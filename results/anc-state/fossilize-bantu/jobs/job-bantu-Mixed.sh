...
#PBS -o /panfs/panasas01/arch/sp16194/terminology-anc-state/fossilize-bantu/logs/bantu-Mixed-fossilize-output.txt
#PBS -e /panfs/panasas01/arch/sp16194/terminology-anc-state/fossilize-bantu/logs/bantu-Mixed-fossilize-error.txt
...
LogFile fossilize-bantu/output/Mixed_$DATE;
run;
ANSWERS
