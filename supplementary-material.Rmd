...
The code for all signal tests can be found in file `analysis/signal-tests.R`. This file comes with helper functions `analysis/signal-functions` & `analysis/mantel-functions` for the D-statistic and Mantel tests respectively. 
...
print(
  recnode %>% 
    kable(format = 'html', 
          caption = "Ancestral state for PMP",
